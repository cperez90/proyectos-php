                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <el-dropdown class="relative ml-3">
                        <?php if ($_SESSION['user'] ?? false) : ?>
                            ...
                            <?php else : ?>
                            <a href="/register" class="<?= urlIs('/register') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> rounded-md px-3 py-2 text-base font-medium hover:bg-gra-700 hover:text-white">Register</a>
                            <a href="/login" class="<?= urlIs('/login') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> rounded-md px-3 py-2 text-base font-medium hover:bg-gra-700 hover:text-white">Log In</a>
                        <?php endif; ?>
