<nav class="bg-gray-800/50">
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            ...
            <a href="/ej1/about.php" class="<?= $_SERVER['REQUEST_URI'] == '/ej1/about.php' ? 'bg-gray-900 text-white' : 'text-gray-300' ?> rounded-md px-3 py-2 text-base font-medium hover:bg-gra-700 hover:text-white">About</a>
            <a href="/ej1/contact.php" class="<?= $_SERVER['REQUEST_URI'] == '/ej1/contact.php' ? 'bg-gray-900 text-white' : 'text-gray-300' ?> rounded-md px-3 py-2 text-base font-medium hover:bg-gray-700 hover:text-white">Contact</a>
        </div>
